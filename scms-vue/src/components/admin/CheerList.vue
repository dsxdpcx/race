<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>加油稿管理</el-breadcrumb-item>
    </el-breadcrumb>
...
<!--            ></el-button>-->
            ...
            <el-button
                ...
                size="mini"
                type="danger"
                @click="deletecheer(scope.row.cheerId)"
            ></el-button>
            <!--通过-->
<!--            <el-button-->
...
//获取运动会届时
    ...
    async deletecheer(id) {
      const _this = this;
      const confirmResult = await _this
          .$confirm("此操作将永久删除加油稿，是否继续？", "提示", {
      ...
      axios.delete("/cheer/deletecheer?cheerId=" + id).then((res) => {
        if (res.status == 200) {
